...
- (void)wm_addMenuView {
    ...
    menuView.isNeedUnfoldButton = self.isNeedUnfoldButton;
...
- (void)menuViewDidTapMoreButton:(WMMenuView *)menu {
    if ([self.delegate respondsToSelector:@selector(pageControllerDidTapMoreButton:)]) {
        [self.delegate pageControllerDidTapMoreButton:self];
    }
}
